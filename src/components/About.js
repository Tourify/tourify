    ...
    return(
      <div>
        ...
        <div className = 'content-area-container'>
          ...
          <p className="about-para"> If you are an organization that would like to add your own content contact us at <a href="mailto:hello@tourify.city">hello@tourify.city</a>.</p>
