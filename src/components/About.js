    ...
    return(
      <div>
        ...
        <div className = 'content-area-container'>
          ...
          <p className="about-para">Tourify is an interactive tour experience that brings the culture and history of a city to life through interesting facts and photography. The idea came from the desire to transform a print guide into a digital format for the <a href="https://www.durham-nc.com/" target="_blank" rel="noopener noreferrer">Durham Convention & Visitors Bureau</a>.</p>
